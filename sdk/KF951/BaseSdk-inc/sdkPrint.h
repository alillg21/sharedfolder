...
s32 sdkPrnGetFont(s8 *pFontName, s8 *pFontCharacter, u32 *pSize);
void sdkPrnSetRowGap(u32 uiRowGap);

s32 sdkPrnFillBuffer(u8  *pszBuf, u8 ucAlign, u32 uiFontZoom, u32 uiOffset);
s32 sdkPrnBmpFile(s8 *pcFileName, u32 uiOffset);
s32 sdkPrnLogo(u8 *pBMPBuf, u32 uiOffset);
s32 sdkPrnBitmap(u32 uiX, u32 uiY, u8* pcBitmap, u32 uiWidth, u32 uiHeight);
