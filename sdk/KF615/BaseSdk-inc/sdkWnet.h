...
#define SDK_WNET_TYPE_WCDMA  0x02   //NetType: WCDMA (3G)
...
s32 sdkWnetReset(void);
//
s32 sdkWnetCheckSim(void);
s32 sdkWnetInputSimPin(u8 *pucSimPIN);
s32 sdkWnetGetSignal(u32 *puiSignal);
s32 sdkWnetSetDnsServer(u8 * pszMDNS, u8 * pszSDNS);
s32 sdkWnetGetDnsServer(u8 *pszMainDNS, u8 *pszSecDNS);
...
s32 sdkWnetGetLocation(SDK_GPS_LOCATION *pucLocation);
s32 sdkWnetUssdCmd(s32 n, const void *pSendStr, s32 dcs, s32 *m, void *pRecvStr, s32 *pRecvDcs);
s32 sdkWnetGotoSleep(void);
s32 sdkWnetWakeUp(void);
s32 sdkWnetGetModVer(u8 *pucModuleVer);
s32 sdkWnetFirmareUpgrade(s8 *pcFileName);
//
