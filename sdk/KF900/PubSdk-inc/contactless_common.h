...
#define CLSS_EXCEPTION       -37 // 卡片在终端异常文件中 
#define CLSS_BLACKLIST        -38 //added by yfl 
...
typedef Clss_PreProcInterInfo  T_Clss_PreProcInterInfo;
...
typedef Clss_TransParam  T_Clss_TransParam;
